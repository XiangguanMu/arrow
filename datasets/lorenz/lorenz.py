...
# (n_ts, n_node)
n_nodes = 4
X_np, GC = simulate_lorenz_96(p=n_nodes, F=10, T=1000, delta_t=0.1)
X = X_np.T 
lag=1
nlags = [lag]*n_nodes
nbins = 4
...
plt.savefig('results/lorenz/graph.png')
...
if __name__ == '__main__':
    ...
    for i in range(n_nodes):
        ...
        surd.plot(I_R, I_S, info_leak, axs, n_nodes, threshold=1e-5)
        ...
        plt.savefig(f'results/lorenz/{i+1}.png')